...
1. Upload the folder 'woocommerce-sales-by-country-report` to the `/wp-content/plugins/` folder
...
= 1.6.8 =
* Tested with WooCommerce 7.6.0 and WordPress 6.2
...
= 1.6.5 =
* WP tested upto 5.7
* WC compatibility added upto 5.1
...
= 1.6 =
* Bug Fixed - undefined country sales warning
